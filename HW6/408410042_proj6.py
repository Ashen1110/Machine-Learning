# -*- coding: utf-8 -*-
"""408410042_proj6.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1D3LG75X6FrsfIEY4BkhaK-CK9lo93HXt
...
# %cd /content/drive/MyDrive/Colab Notebooks/ML_CNN
# %ls
...
data_transforms = {
        'train': transforms.Compose([
            ...
            transforms.RandomAdjustSharpness(sharpness_factor=2.5), # 銳化
            transforms.RandomCrop(size=(224,224), padding=64, padding_mode='edge'), # 裁切
            transforms.RandomRotation(50),
            transforms.RandomCrop((224,224), padding=None, pad_if_needed=False, fill=0, padding_mode='constant'),
